...
namespace Sharpdown.MarkdownElement.InlineElement
{
    ...
    public class InlineText : InlineElement
    {
        ...
        internal static string HandleEscapeAndHtmlEntity(string text, bool backslashEscapeEnabled = true)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                if (text[i] == '&')
                {
                    ...
                    if (colon != -1)
                    {
                        string entity = text.Substring(i + 1, colon - i - 1);
                        if (entityCharacter.TryGetValue(entity, out string entityValue))
                        {
        ...
        /// <summary>
        /// Returns a character equivalent to <paramref name="codePoint"/>.
        /// </summary>
        /// <param name="codePoint">The coe point if the character.</param>
        /// <returns>
        /// A character equivalent to <paramref name="codePoint"/>.
        /// If 0 or other number which is invalid for unicode code point is specified,
        /// this method returns 0xFFFD.
        /// </returns>
        private static char GetSecureChar(uint codePoint)
        {
